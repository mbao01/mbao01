...
export const getDatetimeInputClasses = cva(
  "min-w-8 p-1 inline tabular-nums h-fit border-none outline-hidden select-none content-box caret-transparent min-w-8 text-center focus:outline-hidden focus:bg-base-content/20 focus-visible:ring-0 focus-visible:outline-hidden",
  {
    variants: {
      size: {
        xs: "max-h-4",
